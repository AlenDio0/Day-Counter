...
namespace DayCounter
{
    ...
    public static class DCData
    {
        ...
        public static string Label_TextOutlineColor => "Outline Color";

        public static string Label_Red => "Red";
        public static string Label_Green => "Green";
        public static string Label_Blue => "Blue";
    }
}
